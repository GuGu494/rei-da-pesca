    ...
    <section id="localizacao" className="localizacao-section">
      <div className="localizacao-grid">
        ...
        <div className="info-col">
          ...
          <a href="#" className="link-admin">Acesso administrativo</a>
        </div>
        ...
        <div className="map-col">
          ...
          <div className="map-container">
            {/* Iframe do Google Maps (Você pode trocar o link depois para o endereço real) */}
            <iframe 
      ...
      {/* Linha e texto de Copyright no final */}
